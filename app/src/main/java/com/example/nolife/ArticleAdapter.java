...
public class ArticleAdapter extends ListAdapter<Article, ViewHolder> {

    public ArticleAdapter(@NonNull DiffUtil.ItemCallback<Article> diffCallback) {
        super(diffCallback);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(v).navigate(R.id.action_news_to_article, bundle);
            }
        });
    }
